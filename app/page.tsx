      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 text-center">
        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
          <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
            Announcing our new features. <Link href="/blog" className="font-semibold text-blue-600"><span className="absolute inset-0" aria-hidden="true" />Read more <span aria-hidden="true">&rarr;</span></Link>
          </div>
        </div>
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          ...
          <a href="https://github.com" className="text-sm font-semibold leading-6 text-gray-900 flex items-center gap-1">
